        ...
        <aside className="w-20 h-full border-r border-white/10 glass flex flex-col items-center py-8 shrink-0 z-50">
            ...
            <div className="flex-1 flex flex-col gap-6">
                ...
                <button
                    ...
                    aria-current={currentScreen === 'executions' ? 'page' : undefined}
                >
                ...
                <button
                    ...
                    title="Captures"
                    aria-label="Captures"
                    aria-current={currentScreen === 'captures' ? 'page' : undefined}
                >
            ...
            <button
                onClick={onLogout}
                className="w-12 h-12 rounded-2xl flex items-center justify-center text-gray-500 hover:bg-red-500/10 hover:text-red-500 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50"
                title="Logout"
                aria-label="Logout"
            >
